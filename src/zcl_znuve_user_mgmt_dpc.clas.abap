class ZCL_ZNUVE_USER_MGMT_DPC definition
  public
...
protected section.
  ...
  methods USERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZNUVE_USER_MGMT_MPC=>TS_USER
    raising
  ...
  methods USERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZNUVE_USER_MGMT_MPC=>TT_USER
...
CLASS ZCL_ZNUVE_USER_MGMT_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 11/02/2022 19:56:27 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZNUVE_USER_MGMT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA userset_create_entity TYPE zcl_znuve_user_mgmt_mpc=>ts_user.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA userset_get_entity TYPE zcl_znuve_user_mgmt_mpc=>ts_user.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZNUVE_USER_MGMT_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA userset_get_entityset TYPE zcl_znuve_user_mgmt_mpc=>tt_user.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA userset_update_entity TYPE zcl_znuve_user_mgmt_mpc=>ts_user.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
