class ZCL_ZNUVE_USER_MGMT_MPC definition
  public
...
CLASS ZCL_ZNUVE_USER_MGMT_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZNUVE_USER_MGMT_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZNUVE_USER_MGMT_USER_S'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20221103030707'.                  "#EC NOTEXT
